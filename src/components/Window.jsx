...
const Window = ({ title, children, onClose, isOpen }) => {
    ...
    return (
        ...
        >
            <div 
                ref={nodeRef}
                className={`w-full h-full bg-[#1e3a5f] rounded-xl shadow-[0_8px_0_0_rgba(0,0,0,0.4)] border-[6px] border-double border-[#f6c253] overflow-hidden flex flex-col transform ${
            ...
            >
                ...
                {/* Contenido */}
                <div className="flex-1 overflow-y-auto bg-[#1e3a5f] text-blue-50">
                    {children}
                </div>
            </div>
        </Rnd>
